...
/**
 * SharePreference帮助类，独立于SPHelper，可用来存储“退出登录”后不清空的数据
 * Created by ZuoHailong on 2019/12/30.
 */
public class SPStaticHelper {

    private static final String SP_NAME_ZBASE_STATIC = "sp_name_zbase_static";

    private static SPUtils getInstance() {
        return SPUtils.getInstance(SP_NAME_ZBASE_STATIC);
    }
